        ...
        <div class="covers-main w3layouts">
            <div class="wrapper">
                <div class="main-cover w3">
                    <h1>
                        <router-link to="/" class="logo">Page Not Found</router-link>
                    </h1>
                    <h4 class="cover-para w3ls">404</h4>
                    <p class="form-text">The page you are looking for might have been removed had its name changed or is temporarily unavailable</p>
                    <router-link to="/" class="back-button">Back to Home</router-link>
                </div>
				<!---728x90--->
                <div class="copyright text-center">
                    <p> Copyright &copy; {{new Date().getFullYear()}} | Jesus Christ the same yesterday, and to day, and for ever.</p>
                </div>
            </div>
        </div>
    </section>
...
.error-page .covers-main {
  background: url('https://res.cloudinary.com/tejuosho4sq/image/upload/v1570806092/error.jpg') no-repeat center;
